...
<div class="card" style="margin-bottom: 20px;">
    <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 20px;">
        ...
        <div>
            ...
            <p style="color: var(--text-soft); font-size: 13px; margin: 0;">Представитель компании</p>
        </div>
    </div>
    ...
    <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px;">
        ...
        <div style="padding: 12px; background: #F9FAFB; border-radius: 12px; text-align: center;">
            <div style="font-size: 24px; font-weight: 700; color: #16A34A;">{{ number_format($loans->sum('amount'), 0, ',', ' ') }} ₽</div>
        ...
        <form action="{{ route('client.profile.update') }}" method="POST">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="short_name" value="{{ $client->short_name }}">
                </div>
                <div class="form-group">
                    <label>Юридический адрес</label>
                    <textarea name="legal_address" rows="2">{{ $client->legal_address }}</textarea>
                </div>
                <div class="form-group">
                    <label>Телефон</label>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('manager.registrations.download-document', ['registration' => $doc->registration_request_id, 'document' => $doc]) }}" 
                           target="_blank" style="color: #0F5ECC;">📥 Скачать</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<div class="card">
    ...
    @else
        <div style="text-align: center; padding: 40px;">
            <div style="font-size: 48px;">💰</div>
            <p style="color: var(--text-muted);">У вас пока нет кредитов</p>
